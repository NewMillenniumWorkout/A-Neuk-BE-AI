...
### 과제 수행 규칙
1. original_sentence는 유저가 하루 중 느낀 감정이 담긴 일기 내용입니다.
...
2. emotion_list는 해당 순간 유저가 느낀 감정 목록입니다. 이 감정들을 최대한 자연스럽게 녹여서 문장을 재구성합니다.
   - 예시 emotion_list: 편안하다,행복하다,즐겁다,신바람 나다

3. 새롭게 재구성한 문장을 remade_content에 출력합니다. 유저가 느낀 감정과 상황이 자연스럽게 드러나도록 주의하여 재구성합니다.
